            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>添加商品分类 </h5><a href="{:U('goods/fenlei')}"><h5 class="pull-right">返回商品分类</h5></a>
                    </div>
                    <div class="ibox-content">
                        <form action="{:U('goods/fenleiadd')}" method="post" enctype="multipart/form-data" class="form-horizontal m-t">
                                ...
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input name="gc_name" class="form-control" type="text" value="" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <label class="checkbox-inline">
                                                    <input type="radio" name="status" value="0" checked>开启</label>
                                                <label class="checkbox-inline">
                                                    <input type="radio" name="status" value="1">关闭</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
