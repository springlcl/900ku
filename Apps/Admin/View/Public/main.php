...
<div class="row">
                    ...
                    <div class="ibox-content">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <tr>
                                    <td>操作系统：</td>
                                    <td>Win(32/64) / Linux</td>
                                </tr>
                                <tr>
                                    <td>服务器版本</td>
                                    <td>Apache/2.2.27 (Unix) mod_ssl/2.2.27 OpenSSL/1.0.1h</td>
                                </tr>
                                <tr>
                                    <td>MySQL版本：</td>
                                    <td>5.4.3</td>
               ...
               <!--  <div class="ibox float-e-margins">
                   ...
                   <table class="table table-striped">
                           ...
                           <tbody>
                               ...
                               <tr>
                                   <td>联系方式</td>
                                   <td>QQ:1217350788 MSN:zhangxs@lsjckj.com TEL:13810830574</td>
                               </tr>
                           </tbody>
                       </table>
                   </div>
    ...
    <script src="__ADMIN_PUBLIC__/js/content.min.js"></script>
    <script src="__ADMIN_PUBLIC__/js/welcome.min.js"></script>
</body>
