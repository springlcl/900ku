...
<!--                                    <a href="javascript:;"><button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal"> 添加导航分类</button> </span></a>-->
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <if condition="$fenlei">
                                    ...
                                    <tr>
                                        <td>{$vo.nav_type_id}</td>
                                        <td>{$vo.type_name}</td>
                                        <td>{$vo.biaoshi}</td>
                                        <td>{$vo.liebiao}</td>
                                        <td style="text-align: center; ">
                                            <a href="{:U('system/nav_list/fid/'.$vo['nav_type_id'])}" class="btn btn-info btn-xs"><i class="fa fa-search" aria-hidden="true"></i> 查看</a>
                                            <a href="{:U('system/nav_first_edit/fid/'.$vo['nav_type_id'])}" class="btn btn-primary btn-xs"><i class="fa fa-edit" aria-hidden="true"></i> 编辑</a>
                                            <!--<a href="http://wx.weisoul.org/admin.php/goods/del/2" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash" aria-hidden="true"></i> 删除</a>-->
                                        </td>
                                    </tr>
                                    </volist>
                                </if>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" role="form" action="{:U('system/nav')}" method="post" enctype="multipart/form-data">
                    <div id="myTabContent" class="tab-content">
                        <div class="modal-body tab-pane fade active in" role="tabpanel" id="tabs1" aria-labelledby="1tab">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="type_name" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">分类标识</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="biaoshi" placeholder="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">导航列表</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="liebiao" placeholder="">
                                </div>
                            </div>
                        </div>
                    </div>
