                                ...
                                <volist name="fenlei" id="vo">
                                    <tr>
                                        ...
                                        <td style="text-align: center; ">
                                            <a href="{:U('system/advert_list/fid/'.$vo['tid'])}" class="btn btn-info btn-xs"><i class="fa fa-search" aria-hidden="true"></i> 查看</a>
                                            <a href="{:U('system/advert_first_edit/fid/'.$vo['tid'])}" class="btn btn-primary btn-xs"><i class="fa fa-edit" aria-hidden="true"></i> 编辑</a>
