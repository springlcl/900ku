                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <a href="javascript:;"><button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal"> 添加快递公司</button> </span></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <foreach name="kuaidi" item="v">
                                <tr>
                                    ...
                                    <td style="text-align: center; ">
                                        <a href="{:U('system/kuaidi_edit/',array('eid'=>$v['eid']))}" class="btn btn-primary btn-xs" ><i class="fa fa-edit" aria-hidden="true"></i> 编辑</a>
                                        <a href="{:U('system/kuaidi_del/',array('eid'=>$v['eid']))}" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash" ></i> 删除</a>
                                    </td>
                                </tr>
                            </foreach>
                            </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">添加快递公司</h4>
            </div>
            <form class="form-horizontal" role="form" action="{:U('system/kuaidi_add')}" method="post" enctype="multipart/form-data">
                <div id="myTabContent" class="tab-content">
                    <div class="modal-body tab-pane fade active in" role="tabpanel" id="tabs1" aria-labelledby="1tab">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ex_name" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">公司代号</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ex_code" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">公司网址</label>
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="ex_url" placeholder="">
                            </div>
                        </div>
                        <div class="form-group">
