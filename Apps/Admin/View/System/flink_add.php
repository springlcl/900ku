            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>添加友情链接 </h5><a href="{:U('system/flink')}"><h5 class="pull-right">返回友情链接</h5></a>

                    </div>
                    <div class="ibox-content">
                        <form action="{:U('system/flink_add')}" method="post" enctype="multipart/form-data" class="form-horizontal m-t">
                                ...
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input name="webname" class="form-control" type="text" value="" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input name="url" class="form-control" type="text" value="" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">链接排序：</label>
                                            <div class="col-sm-4">
                                                <input name="sort_order" class="form-control" type="text" value="" placeholder="">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <label class="checkbox-inline">
                                                    <input type="radio" name="is_show" value="0" checked>开启</label>
                                                <label class="checkbox-inline">
                                                    <input type="radio" name="is_show" value="1">关闭</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
