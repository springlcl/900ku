            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>编辑收款银行 </h5><a href="{:U('system/bank')}"><h5 class="pull-right">返回收款银行</h5></a>

                    </div>
                    <div class="ibox-content">
                        <form action="{:U('system/bank_edit')}" method="post" enctype="multipart/form-data" class="form-horizontal m-t">
                            <input name="bid" type="hidden" value="{$arr['bid']}">
