            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>编辑导航分类 </h5><a href="{:U('system/nav')}"><h5 class="pull-right">返回导航分类</h5></a>

                    </div>
                    <div class="ibox-content">
                        <form class="form-horizontal" role="form" action="{:U('system/nav_first_edit')}" method="post" enctype="multipart/form-data">
                            <div id="myTabContent" class="tab-content">
                                <div class="modal-body tab-pane fade active in" role="tabpanel" id="tabs1" aria-labelledby="1tab">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="hidden" name="nav_type_id" value="{$arr['nav_type_id']}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="liebiao" placeholder="" value="{$arr['liebiao']}">
                                        </div>
                                    </div>
                                </div>
                            </div>
