                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <a href="javascript:;"><button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal"> 添加敏感词</button> </span></a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <foreach name="mingan" item="v">
                                    <tr>
                                        <td>{$v.mid}</td>
                                        <td>{$v.name}</td>
                                        <td style="text-align: center; ">
                                            <a href="{:U('system/mingan_edit/',array('mid'=>$v['mid']))}" class="btn btn-primary btn-xs" ><i class="fa fa-edit" aria-hidden="true"></i> 编辑</a>
                                            <a href="{:U('system/mingan_del/',array('mid'=>$v['mid']))}" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash" ></i> 删除</a>
                                        </td>
                                    </tr>
                                </foreach>
                            </tbody>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="form-horizontal" role="form" action="{:U('system/mingan_add')}" method="post" enctype="multipart/form-data">
