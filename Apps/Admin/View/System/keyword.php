                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                <div class="input-group">
                                    <a href="javascript:;"><button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#myModal"> 添加热门搜索词</button> </span></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <foreach name="keyword" item="v">
                                        <tr>
                                            ...
                                            <td style="text-align: center; ">
                                                <a href="{:U('system/keyword_edit/',array('sid'=>$v['sid']))}" class="btn btn-primary btn-xs" ><i class="fa fa-edit" aria-hidden="true"></i> 编辑</a>
                                                <a href="{:U('system/keyword_del/',array('sid'=>$v['sid']))}" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash" ></i> 删除</a>
                                            </td>
                                        </tr>
                                    </foreach>
                                </tbody>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">添加热门搜索词</h4>
                </div>
                <form class="form-horizontal" role="form" action="{:U('system/keyword_add')}" method="post" enctype="multipart/form-data">
