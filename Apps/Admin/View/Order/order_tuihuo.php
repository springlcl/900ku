                        ...
                        <div class="row">
                            <div role="form" class="form-inline">
                                <div class="col-sm-2 m-b-xs">
                                    <form action="{:U('order/return_goods')}" method="post">
                                ...
                                <div class="checkbox m-l m-r-xs">
                                    <a href="{:U('order/limitday_return/day/1')}">最近7天</a>　<a href="{:U('order/limitday_return/day/2')}">最近30天</a>
                                </div>
                                </form>
                            ...
                            <table class="table table-hover">
                                ...
                                <if condition="$datalist">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <if condition="$vo.status eq 8">退货中
                                                <elseif condition="$name eq 9"/>退货完成
                                                <else/>申请中
                                            </if>
                                        </td>
                                        <td>{$vo.created|date="Y-m-d H:i:s",###}</td>
                                        <td style="text-align: center; ">
                                            <a href="{:U('order/return_goods_info/oid/'.$vo['oid'])}">查看详情</a>
                                        </td>
                                    </tr>
                                    </volist>
                                </if>
