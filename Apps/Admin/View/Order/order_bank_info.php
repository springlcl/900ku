            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>订单详情</h5><a href="{:U('order/zhunru')}"><h5 class="pull-right">返回订单列表</h5></a>
                    </div>
                    <div class="ibox-content">
                        <div class="row  border-bottom white-bg dashboard-header">
                            <div class="col-sm-12 text-center">
                               <img src="__ADMIN_PUBLIC__/img/order-status{$info['status']}.png" height="100">
                            </div>
                            ...
                            <div class="tab-content">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>{$info['pro_name']}</td>
                                                <td class="bg-hui">付款状态</td>
                                                <td>
                                                    <if condition="$info['pay_stat'] eq 1">预付款已付
                                                        <elseif condition="$info['pay_stat'] eq 2"/>发货款已付
                                                        <elseif condition="$info['pay_stat'] eq 3"/>质保金已付
                                                        <else/>待付预付款
                                                    </if>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <if condition="$info['status'] eq 0">商品下单
                                                        <elseif condition="$info['status'] eq 1"/>支付预付款
                                                        <elseif condition="$info['status'] eq 2"/>商品出库
                                                        <elseif condition="$info['status'] eq 3"/>支付发货款
                                                        <elseif condition="$info['status'] eq 4"/>供应商发货
                                                        <elseif condition="$info['status'] eq 5"/>付验收款
                                                        <elseif condition="$info['status'] eq 6"/>付质保金
                                                        <elseif condition="$info['status'] eq 7"/>订单完成
                                                        <elseif condition="$info['status'] eq 9"/>退货申请中
                                                        <elseif condition="$info['status'] eq 10"/>退货中
                                                        <elseif condition="$info['status'] eq 11"/>退货完成
                                                        <else/>未查询到
                                                    </if>
                                                </td>
                                            </tr>
                                ...
                                <div id="tab-2" class="tab-pane">
                                    <div class="panel-body">
                                        ...
                                        <div>应付金额：￥4500 　已付金额：￥500 　未付金额：￥4000</div><br/>
