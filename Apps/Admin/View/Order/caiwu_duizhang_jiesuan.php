            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="row" style="border-bottom:1px solid #eee;margin-bottom: 20px;">
                        <a href="{:U('order/duizhang_daijiesuan')}" class="btn btn-default"> 待结算</a>
                        <a href="{:U('order/duizhang_jiesuan')}" class="btn btn-primary"> 已结算</a>
                    </div>
                    <div class="row">
                        <div role="form" class="form-inline">
                            <div class="col-sm-2 m-b-xs">
                                <form action="{:U('order/duizhang_jiesuan')}" method="post">
                            ...
                            <form action="" method="post">
                                ...
                                <div class="checkbox m-l m-r-xs">
                                    <a href="{:U('order/limitday_tongji_jiesuan/day/1')}">最近7天</a>
                                    <a href="{:U('order/limitday_tongji_jiesuan/day/2')}">最近30天</a>
                                </div>
                                <div class="input-group">
                                    <a href="{:U('order/duizhang_jiesuan_csv')}"><button type="button" class="btn btn-sm btn-primary"> 导出</button></a>
                                </div>
                            </form>
                                ...
                                <volist name="data" id="vo">
                                    <tr>
                                        ...
                                        <td style="text-align: center; ">
                                            <a href="javascript:void(0);" class="btn btn-primary btn-xs"><i class="fa fa-edit" aria-hidden="true"></i> 审核</a>
                                        </td>
                                    </tr>
                                </volist>
                            </if>
