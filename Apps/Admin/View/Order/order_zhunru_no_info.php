            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>订单详情</h5><a href="{:U('order/zhunru_no')}"><h5 class="pull-right">返回订单列表</h5></a>
                    </div>
                    <div class="ibox-content">
                        <div class="row  border-bottom white-bg dashboard-header">
                            <div class="col-sm-12 text-center">
                                <if condition="$info['status'] lt 7">
                                    <img src="__ADMIN_PUBLIC__/img/order-zhunru_no{$info['status']}.png" height="100">
                                    <else />
                                    <img src="__ADMIN_PUBLIC__/img/order-return{$info['status']}.png" height="100">
                                </if>
                            </div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <if condition="$info['pay_stat'] eq 1">已付
                                                        <elseif condition="$info['pay_stat'] eq 2"/>未付
                                                    </if>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <if condition="$info['status'] eq 1">支付全款
                                                        <elseif condition="$info['status'] eq 2"/>商品出库
                                                        <elseif condition="$info['status'] eq 3"/>供应商发货
                                                        <elseif condition="$info['status'] eq 4"/>确认发货
                                                        <elseif condition="$info['status'] eq 5"/>订单完成
                                                        <elseif condition="$info['status'] eq 7"/>退货申请中
