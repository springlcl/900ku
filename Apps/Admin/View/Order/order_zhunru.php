                        ...
                        <div class="row">
                            <div role="form" class="form-inline">
                                <div class="col-sm-2 m-b-xs">
                                    <form action="{:U('order/zhunru')}" method="post">
                                ...
                                <div class="checkbox m-l m-r-xs">
                                    <a href="{:U('order/limitday/day/1')}">最近7天</a>　<a href="{:U('order/limitday/day/2')}">最近30天</a>
                                </div>
                                </form>
                                ...
                                <if condition="$datalist">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center; ">
                                            <a href="{:U('order/zhunru_info/oid/'.$vo['oid'])}">查看详情</a>
                                        </td>
                                    </tr>
                                    </volist>
                                </if>
