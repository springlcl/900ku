            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>商品列表</h5><!--<a href="goods_art_type.html"><h5 class="pull-right">返回商品栏目属性类别</h5></a>-->
                    </div>
                    <div class="ibox-content">
                        <div class="row">
                            ...
                            <div class="col-sm-2 m-b-xs">
                                <form action="{:U('goods/listing')}" method="post">
                                <div class="input-group">
                                    <input type="text" name="search" class="input-sm form-control input-s-sm inline" placeholder="商品编号/名称">
                            ...
                            <div class="col-sm-2 m-b-xs">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="gcid" class="input-sm form-control input-s-sm inline">
                            ...
                            <div class="col-sm-2 m-b-xs">
                                ...
                                <div class="input-group">
                                    ...
                                    <select name="exid" class="input-sm form-control input-s-sm inline">
                            ...
                            <div class="col-sm-2">
                                <div class="input-group">
                                    <a href="{:U('goods/goods_csv')}"><button type="button" class="btn btn-sm btn-primary"> 导出</button> </a>
                                </div>
                            </div>
                        </div>
