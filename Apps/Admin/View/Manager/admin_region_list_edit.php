            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>编辑管理员 </h5><a href="{:U('manager/admin_region_list')}"><h5 class="pull-right">返回管理员列表</h5></a>
                    </div>
                                ...
                                <div id="tab-1" class="tab-pane active">
                                    <div class="panel-body">
                                        ...
                                        <div id="demo1" class="citys">
											...
											<input name='province_jy' type='hidden' value="{$data['province_jy']}" class='dizhi1'>
											<input name='city_jy' type='hidden' value="{$data['city_jy']}" class='dizhi2'>
