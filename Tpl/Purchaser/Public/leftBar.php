<div class="left_con fl">
    ...
    <ul class="nav">
        ...
        <li <if condition="'__CONTROLLER__' eq '__MODULE__'.'/Index'">class="active"</if>>
            <div class="one-level pdw20 clearfix">
        ...
        <li <if condition="'__CONTROLLER__' eq '__MODULE__'.'/Financial'">class="active"</if>>
            <div class="one-level pdw20 clearfix">
        ...
        <li class="<if condition="'__CONTROLLER__' eq '__MODULE__'.'/Order'">active</if>">
            <div class="one-level pdw20 clearfix">
            ...
            <dl class="two-level">
                <a href="{:U('Order/access')}"><dd class="<if condition="'__ACTION__' eq '__CONTROLLER__'.'/access'">active</if>"><i class="mgr5">•</i>准入订单</dd></a>
                <a href="{:U('Order/nonAccess')}"><dd class="<if condition="'__ACTION__' eq '__CONTROLLER__'.'/nonAccess'">active</if>"><i class="mgr5">•</i>非准入订单</dd></a>
                <a href="{:U('Order/returnList')}"><dd class="<if condition="'__ACTION__' eq '__CONTROLLER__'.'/returnList'">active</if>"><i class="mgr5">•</i>退货列表</dd></a>
            </dl>
        </li>
        <li class="<if condition="'__CONTROLLER__' eq '__MODULE__'.'/Employee'">active</if>">
            <div class="one-level pdw20 clearfix">
