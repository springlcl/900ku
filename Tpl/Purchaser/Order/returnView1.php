				...
				<div class="lreturn_information">
					<div class="title_ty">
		      		...
		      		<div class="application-information">
						<div class="application-time pdb20">
		      			...
		      			<div class="commodity_information ">
		      				...
		      				<ul class=" pdb20">
		      					...
		      					<li class="mgt20"><span  class="text-right mgr10 w140">卖家收货地址：</span><span class="mgr10">北京市昌平区北七家镇什么街道什么楼门牌号</span> </li>
		      				</ul>
		      				<ul class=" pdb20">
		      					<h6 class="fs-14 fw600 pdl15 mgt50">物流信息</h6>
		      					<li>
		      						<div class="lo_tit mgt20 clearfix">
                    				    <span class="col-666 fs-16">物流</span>
                					</div>
		      						<span class="text-right mgr10 w140">快递公司：</span><span class="mgr35">圆通快递</span>
		      						<span class="mgr35">物流单号：47689797865432576</span>
									<!-- <button class="fw600 bg-f5">查看物流</button> -->
