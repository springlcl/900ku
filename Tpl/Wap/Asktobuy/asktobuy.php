...
<head>
    ...
    <link rel="shortcut icon" href="__WAP_PUBLIC__/images//.ico" type="image/x-icon">
    <script src="__WAP_PUBLIC__/js/jquery-1.8.3.min.js"></script>
    
</head>
<body>
    <div class="publish_buy_head">
    <!-- <img src="__WAP_PUBLIC__/images//publish_buy.jpg" alt=""> -->
    ...
    <div class="publish_buy_float">
        <div style="float:left;" class="publish_buy_float_left">
            <ul>
                <li>
                    <div style="color:#3FA49E;float:left;line-height:30px;">*</div><div style="float:left;width:60px;height:30px;line-height:30px;">采购产品</div><div style="width:300px;height:30px;border:2px solid #C8C5C3;float:left;"><input style="border:none;height:30px;width:220px;float:left;" type="search" name="cg_name" placeholder="" />
            ...
            <ul>
                <li style="margin-top:20px;margin-left:100px;float:left;">
                    <div style="float:left;">
                        <a href=""><img style="display:inline-block;" src="__WAP_PUBLIC__/images//publish_buy_1.jpg" alt=""></a>
                    </div>
                ...
                <li style="margin-top:40px;margin-left:100px;float:left;">
                    <div style="float:left;">
                        <a href=""><img style="display:inline-block;" src="__WAP_PUBLIC__/images//publish_buy_2.jpg" alt=""></a>
                    </div>
                    <div style="float:left;margin-left:30px;line-height:30px;font-size:16px;">
                ...
                <li style="margin-top:40px;margin-left:100px;float:left;">
                    <div style="float:left;">
                        <a href=""><img style="display:inline-block;" src="__WAP_PUBLIC__/images//publish_buy_3.jpg" alt=""></a>
                    </div>
                    <div style="float:left;margin-left:30px;line-height:30px;font-size:16px;">
                ...
                <li style="margin-top:40px;margin-left:100px;float:left;">
                    <div style="float:left;">
                        <a href=""><img style="display:inline-block;" src="__WAP_PUBLIC__/images//publish_buy_4.jpg" alt=""></a>
                    </div>
                    <div style="float:left;margin-left:30px;line-height:30px;font-size:16px;">
