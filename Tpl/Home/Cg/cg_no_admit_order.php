    ...
    <div class="t_f_management_con order_payment_enquiry_con">
        <div class="order_payment_enquiry_right">
          <div class="zhunruAndFeizhunru">
            <a href="{:U('Cg/cg_admit_order')}"><span >准入订单</span></a>
            <a href="{:U('Cg/cg_no_admit_order')}"><span class="active">非准入订单</span></a>
          </div>
          <div class="order_myself_center bor_1ddd  pdb20">
            <form action="{:U('Cg/cg_no_admit_order')}" method="post">
            ...
            <ul class="order_myself_center_3">
                ...
                <li>
                    <select name="pay_status" id="">
                        ...
                        <option <?php if(!$ps ){ echo "selected='selected'";} ?>  value="0">待付预付款</option>
...
<volist name="oid" id="o">
        ...
        <!--            <div>
                   ...
                   <ul <if condition="$o['status'] eq 0">
                    style="background: url(__HOME_PUBLIC__/finance/images/order-status1.png)30px 29px no-repeat;background-size: 85% 20px;"
                    <elseif condition="$o['status'] eq 1"/>
                     style="background: url(__HOME_PUBLIC__/finance/images/order-status2.png)30px 29px no-repeat;background-size: 85% 20px;"
                      <elseif condition="$o['status'] eq 2"/>
                     style="background: url(__HOME_PUBLIC__/finance/images/order-status3.png)30px 29px no-repeat;background-size: 85% 20px;"
                      <elseif condition="$o['status'] eq 3"/>
                     style="background: url(__HOME_PUBLIC__/finance/images/order-status4.png)30px 29px no-repeat;background-size: 85% 20px;"
                      <elseif condition="$o['status'] eq 4"/>
                      style="background: url(__HOME_PUBLIC__/finance/images/order-status5.png)30px 29px no-repeat;background-size: 85% 20px;"
                      <elseif condition="$o['status'] eq 5"/>
                     style="background: url(__HOME_PUBLIC__/finance/images/order-status6.png)30px 29px no-repeat;background-size: 85% 20px;"
                      <elseif condition="$o['status'] eq 6"/>
                     style="background: url(__HOME_PUBLIC__/finance/images/order-status7.png)30px 29px no-repeat;background-size: 85% 20px;"
                      <elseif condition="$o['status'] eq 7"/>
                     style="background: url(__HOME_PUBLIC__/finance/images/order-status8.png)30px 29px no-repeat;background-size: 85% 20px;"
