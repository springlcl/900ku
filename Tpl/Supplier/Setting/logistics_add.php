...
<!-- 右侧 内容-->
  <div class="clearfix container" id="app-container">
    <form  id="form1" name="form1"  action="{:U('Setting/log_toadd')}" method="post" enctype="multipart/form-data" >
...
<!--          <tr class="clearfix">
             <td><span class="fl mgl15" style="width:180px;">
                北京市，上海市,深圳市
              <input type="hidden" name="area[]" value="深圳市" />
            </span></td>
<td style="width:20px;"><a href="#" ><font color="blue">修改</font> </a>&nbsp;<a href=""><font color="blue">删除</font></a></td>
            <td><input name="first_weight[]" type="text" style="width:45px;" class="fr mgr10"></td>
             <td><input name="first_fee[]" type="text" style="width:45px;" class="fr"></td>
            <td><input name="next_weight[]" type="text" style="width:45px;"  class="fr"></td>
            <td> <input name="next_fee[]" type="text" style="width:45px;"  class="fr"></td>
         </tr> -->
      ...
      <div class="clearfix anniu">
        <p class="fl">&nbsp;</p>
        <button  onClick="document.form1.action='{:U('Setting/log_toadd')}';"  class="mgl20 baocun">保存</button>
        <button onClick="document.form1.action='{:U('Setting/log_show')}';"  class="mgl20 baocun">返回</button>
      </div>
    </div>
  </form>
    <!-- 底部 == 版权 -->
 ...
 <!--新建选择配送区域 -->
    <div class="area-modal-wrap">
      ...
      <input id="four_data" type="hidden" value="" />
      <li area-id="120000">
        <div class="area-editor-list-title">
          <div class="area-editor-list-title-content">
            <div class="js-ladder-toggle area-editor-ladder-toggle extend">+</div>
      ...
      <div class="area-modal-foot">
        <button id="areabu" class="btn btn-primary btn-wide js-modal-save" style="color: #fff;">
          确定
        </button>&nbsp;&nbsp;
        <button class="btn btn-default btn-wide js-modal-close ">
          取消
...
//     };
//     var data=arr.join(",");
//     $(".table").append('<tr class="clearfix"><td><span class="fl mgl15" style="width:120px;">'+data+'<input type="hidden" name="area[]" value="'+data+'" /></span></td><td style="width:20px;"><a href="#" ><font color="blue">修改</font> </a>&nbsp;<a href=""><font color="blue">删除</font></a></td><td><input name="first_weight[]" type="text" style="width:45px;" class="fr mgr10"></td><td><input name="first_fee[]" type="text" style="width:45px;" class="fr"></td><td><input name="next_weight[]" type="text" style="width:45px;"  class="fr"></td><td> <input name="next_fee[]" type="text" style="width:45px;"  class="fr"></td></tr>');
// });
    function trdel(e)
    {
