...
<!-- 右侧 内容-->
  <div class="clearfix container" id="app-container">
    <form  id="form1" name="form1" method="post"  action="{:U('Setting/log_toedit')}" enctype="multipart/form-data" >
    <div class="cont_lump cont_lump_sell Logisticsfreightmodule ">
      ...
      <div class="mobanmingcheng clearfix">
          <p class="fl">模板名称：</p>
          <input type="text" name="tem_name" value="{$name.tem_name}">
      </div>
...
<td style="width:20px;"><a href=""><font color="blue"  tid="{$l.tid}" class="tidedit">修改</font></a>&nbsp;
  <a href=""><font color="blue" tid="{$l.tid}" class="tiddel">删除</font></a></td>
            ...
            <td><input value="{$l.first_weight}" name="first_weight[]" type="text" style="width:45px;" class="fr mgr10"></td>
             <td><input value="{$l.first_fee}"  name="first_fee[]" type="text" style="width:45px;" class="fr"></td>
            <td><input value="{$l.next_weight}"  name="next_weight[]" type="text" style="width:45px;"  class="fr"></td>
            <td> <input value="{$l.next_fee}"  name="next_fee[]" type="text" style="width:45px;"  class="fr"></td>
         </tr>
      ...
      <div class="clearfix anniu">
        <p class="fl">&nbsp;</p>
        <button  onClick="document.form1.action='{:U('Setting/log_toedit')}';"  class="mgl20 baocun">保存</button>
