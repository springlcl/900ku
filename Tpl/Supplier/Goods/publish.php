...
<div class="clearfix container" id="app-container" target="{$url}">
    <div class="cont_lump cont_lump_Release">
        ...
        <form action="{:U('publish')}" enctype="multipart/form-data" method="post" id="data" class="registerform">
        <table>
            <tr class="basic">
                <td>基本信息</td>
                <td>
                    <div class="clearfix">
                        ...
                        <volist name="cates" id="c" key="k">
                            <select name="cate" class="cate" level="{$k}">
                                <volist name="c" id="v">
                                    <option value="{$v.gcid}" >{$v.gc_name}</option>
                                </volist>
                            </select>
                        </volist>
                        <input type="hidden" name="goods_type" value="{$type}"/>
                    </div>
                ...
                <td class="attribute">
                    ...
                    <div class="clearfix">
                        ...
                        <ul pro="{$key}">
                            ...
                            <li  attr="{$list[$l]['aid']}" group="{$list[$l]['nid']}">{$list[$l]['aval']}</li>
                            </for>
                        </ul>
                    </div>
                    </volist>
            ...
            <tr class="Stock">
                ...
                <td>
                    <div class="clearfix l_shangpinshuxing pro1" level="1">
                        ...
                        <select name="property1" id="property1" data-placeholder="选择一个属性" class="bubian pdl10">
                            ...
                            <volist name="property" id="vo">
                                <option value="{$vo.pro_name}">{$vo.pro_name}</option>
                            </volist>
                        </select>
                    ...
                    <div class="clearfix">
                        ...
                        <input type="text" name="stockTotal" class="bubian" datatype="*" nullmsg="请输入总库存：" errormsg="请输入总库存："  />
                        <input type="checkbox" name="showStock" class="fx" value="0" />
                        页面不显示商品库存
                    </div>
                    <div class="clearfix">
                        <p class="kong">&nbsp;</p>
                        <input type="checkbox" name="allowBook" class="fx" value="1" />
                        库存为0时允许下单
                    </div>
                    <div class="clearfix">
                        <p class="kong">商品编号：</p>
                        <input type="text" class="bubian" name="goodsCode" datatype="*" nullmsg="请输入商品编号：：" errormsg="请输入商品编号：："  />
                    </div>
                </td>
            </tr>
            <tr class="logistics">
                ...
                <td>
                    <div class="clearfix">
                        ...
                        <input type="text" name="goodsName" datatype="*" nullmsg="请输入商品名称" errormsg="请输入商品名称" />
                    </div>
                    <div class="clearfix">
                        <p class="mgt10"><label>*</label>价格：</p>
                        <button type="button" style="font-size: 14px">￥</button><input type="text" name="goodsPrice" class="jiage" placeholder="0.00" datatype="*" nullmsg="请输入商品价格" errormsg="请输入商品价格"  />
                    </div>
                ...
                <td class="clearfix">
                    <div class="clearfix">
                        ...
                        <div style="margin-top: 20px;" class="fl">
                            <input type="radio" <notempty name="Think.get.gid"><gt name="$goods_postage" value="0">checked="checked"</gt></notempty><empty name="Think.get.gid">checked="checked"</empty> name="isFix" value="1" />统一邮费
                        </div>
                        <div class="fl mgl10">
                            <button style="font-size: 14px " type="button">￥</button><input name="postage" type="text" class="jiage" placeholder="0.00" <notempty name="Think.get.gid">{$goods_poatage}</notempty> />
                        </div>
                    </div>
                    <div class="xiala"><p>&nbsp;</p><input type="radio"  name="isFix" value="0" class="mgt10" />运费模板
                        <select name="freight">
                            <option value="0" selected="selected">不使用运费模板</option>
                    ...
                    <div class="zhongliang clearfix">
                        ...
                        <input type="text" name="kg" datatype="*" nullmsg="请输入重量" errormsg="请输入重量" >
                        <span>单位：千克</span>
                    </div>
                    <div class="zhongliang clearfix">
                        <p>
                    ...
                    <div class="clearfix mgt10">
                        ...
                        <input name="rec" type="text" placeholder="最多15个字" class="pdl10 mgt10" style="width: 306px;height: 34px;">
                    </div>
...
<script type="text/javascript" src="__SUP_PUBLIC__/js/publish.js"></script>
<script type="text/javascript" src="__SUP_PUBLIC__/js/Validform_v5.3.2_min.js"></script>
