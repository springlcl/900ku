            ...
            <div class="con clearfix">
                ...
                <ul class="custo_list fl">
                    ...
                    <li class="row clearfix row_notice">
                        <div class="right_con fl">
                            <div class="sanjiao_left_ddd">
                                <h5>公告：<input class="w220" type="text" placeholder="请填写内容,如果过长,将会在手机上滚动显示"></h5>
                            </div>
                        </div>
                    </li>
                ...
                <div class="confirm_rel">
                    <a href="onsell.php"><button class="btn-lan-160 " style="z-index: 999">确认发布</button></a>
                </div>
            </div>
        </div>
        <!-- 底部 == 版权 -->
...
<div class="protection" >
    ...
    <div class="tanchu_box  add_imgs">
        ...
        <div class="foot clearfix">
          ...
          <div class="fr mgt30">
            <button class="btn-lan-80">确定</button>
            <button class="btn-fff-80 close_btn">取消</button>
          </div>
        </div>
    </div>
