...
<div class="clearfix container" id="app-container">
        <div class="cont_lump cont_lump_Customer  cont_lump_yidongguanggao bor_bm1">
          ...
          <div class="span_nav clearfix">
              <span class="fl cur-p active">广告设置PC</span>
          ...
          <div class="advert_form">
              ...
              <ul class="lump pc_form">
                  <li class="">
                      ...
                      <div class="fl">
                        <input type="text" name="sort_order" value="{$data.sort_order}">
                  ...
                  <li class="">
                      ...
                      <div class="fl">
                        <input name="thumb" id="thumb" type="text">
                        <div id='d'>
                  ...
                  <li class="">
                      ...
                      <div class="fl">
                        <input type="text" id="contents"   name="link">
                  ...
                  <li class="radio">
                      ...
                      <div class="fl">
                           <label for="zt_show"><input name="is_show" value="1" type="radio" id="zt_show" checked="checked">显示</label>
                          <label for="zt_hide"><input name="is_show" value="0" type="radio" id="zt_hide">隐藏</label>
                      </div>
                  </li>
                  <li class="">
                ...
                <form method="post" action="" enctype="multipart/form-data" >
                 <input name="media_type" type="hidden" value="1">
                  <li class="">
                      ...
                      <div class="fl">
                        <input name="thumb" id='thumbs' type="text" value="">
                        <div id='d'>
                        <label id='lab'>选择图片</label>
                  ...
                  <li class="">
                      ...
                      <div class="fl">
                        <input type="text" id="content" value="" name="link">
